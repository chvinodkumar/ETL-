...
url_cred = f"https://005-SHS-767.est.com/oauth/token?client_id={client_id}&client_secret={client_secret}&grant_type=client_credentials"
...
while offset >= 0:
   stroff=str(offset)
   url = f"https://005-SHS-767.est.com/rest/asset/v1/programs.json?access_token={access_token}&maxReturn={maxReturn}&offset={stroff}&earliestUpdatedAt={pre_date}T00:00:00-05:00&latestUpdatedAt={curt_date}T00:00:00-05:00"
